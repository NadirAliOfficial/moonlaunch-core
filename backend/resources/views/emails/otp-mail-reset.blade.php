...
<body>
    <div class="container">
        ...
        <p>Hello,</p>
        <p>We received a request to reset the password for your account. To complete the process, please use the OTP (One-Time Password) below:</p>
        ...
        <div class="instructions">
            ...
            <ul>
                <li>Go to the password reset page where you initiated the request.</li>
                <li>Enter the OTP code in the provided field to reset your password.</li>
                <li>Click on "Verify" to proceed with your password reset.</li>
            </ul>
        </div>
