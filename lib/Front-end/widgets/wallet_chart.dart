...
class _WalletChartState extends State<WalletChart> {
  ...
  // ✅ only the moving vertical line will toggle red on tap
  bool _isIndicatorRed = false;
        ...
        return GestureDetector(
          ...
          onScaleUpdate: (details) {
            setState(() {
              ...
              _verticalZoom =
                  (_lastVerticalZoom * details.scale).clamp(1.0, 4.0);
              _touchX = details.localFocalPoint.dx;
            });
          },

          // ✅ Tap anywhere on chart: move indicator + toggle indicator line color
          onTapDown: (d) {
            setState(() {
              _touchX = d.localPosition.dx;
              _isIndicatorRed = !_isIndicatorRed;
            });
          },
          ...
          child: CustomPaint(
            ...
            painter: _WalletChartPainter(
              ...
              scale: _scale,
              touchX: _touchX,
              isIndicatorRed: _isIndicatorRed,
            ),
          ),
        );
      },
...
class _WalletChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // ✅ VERTICAL MOVING LINE (toggle color on tap)
    final verticalPaint = Paint()
      ..color = (isIndicatorRed
              ? const Color(0xFFDB2519)
    ...
    final bubbleY =
        (topPadding - bubbleH - 4).clamp(2.0, size.height - bubbleH);
    ...
    tp.paint(
      canvas,
      Offset(bubbleRect.left + bubblePaddingX,
